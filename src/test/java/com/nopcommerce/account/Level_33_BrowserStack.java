...
public class Level_33_BrowserStack extends BaseTest {
	...
	@Parameters({"userUrl","browser","os","os_version","browser_version"})
	@BeforeClass
	public void beforeClass(String userUrl, String browserName, String os, String os_version, String browser_version) {

		driver = getBrowserDriversOnBroswerStack(userUrl, browserName,  os, os_version, browser_version);
