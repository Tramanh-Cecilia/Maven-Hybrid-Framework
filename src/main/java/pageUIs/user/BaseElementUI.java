...
public class BaseElementUI {
	...
	public static final String HIDDEN_LINK_IN_SUCCESS_MESSAGE ="xpath=//div[@id='bar-notification']//p[@class='content']//a";
	public static final String CLOSE_BUTTON_FOR_SUCCESS_MESSAGE = "xpath=//div[@class='bar-notification success']//span[@class='close']";
	public static final String SUCCESS_MESSAGE_NOTIFICATION = "css=div.bar-notification.success";
	public static final String DYNAMIC_FOOTER_LINK_BY_NAME = "xpath=//div[@class='footer-upper']//a[contains(text (), '%s')]";
	public static final String AJAX_LOADING_ICON = "css=div.ajax-loading-block-window";
}
